import { Dialog, DialogTitle, DialogContent, TextField, MenuItem, DialogActions } from '@mui/material';
...
const AddItemDialog = ({ openAddDialog, handleAddDialogClose, formData, handleInputChange, handleAddItem }) => {
    return (
